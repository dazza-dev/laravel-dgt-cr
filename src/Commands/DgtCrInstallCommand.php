...
namespace DazzaDev\LaravelDgtCr\Commands;

use DazzaDev\LaravelDgtCr\Models\DgtListing;
use Illuminate\Console\Command;
use Illuminate\Support\Facades\File;

class DgtCrInstallCommand extends Command
{
    protected $signature = 'dgt-cr:install';

    protected $description = 'Llena las tablas con la información del paquete DGT CR';

    public function handle()
    {
        $this->info('Iniciando instalación de DGT CR ...');

        $jsonPath = base_path('vendor/dazza-dev/dgt-xml-generator/src/Data');
        ...
        foreach ($files as $file) {
            ...
            DgtListing::insertOrIgnore($formattedData);
